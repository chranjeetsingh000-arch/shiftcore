  ...
  if (done) {
    return (
      <div className="text-center">
        ...
        <Link
          href="/"
          className="inline-block rounded-xl bg-gradient-to-r from-violet-600 to-pink-500 px-8 py-3 text-sm font-bold text-white"
        >
    ...
    <div>
      <div className="text-center mb-8">
        <Link href="/" className="inline-flex items-center gap-2 mb-6">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-violet-600 to-pink-500 text-sm font-black text-white">
            ✈
          </div>
          <span className="text-xl font-black tracking-tight">
            Travel<span className="text-violet-600">OS</span>
          </span>
        </Link>
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        {(["Google", "Apple"] as const).map((provider) => (
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm font-semibold text-gray-700 hover:border-gray-400 hover:bg-gray-100 transition-all"
          >
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full rounded-xl bg-gradient-to-r from-violet-600 to-pink-500 py-3.5 text-sm font-bold text-white shadow-lg shadow-violet-200 transition-all hover:shadow-violet-200 disabled:opacity-60 disabled:cursor-not-allowed"
        >
          {loading ? (
